...
export default async function SessionCaissePage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-lg font-semibold text-accent">Session de caisse</h1>
      ...
      <div className="bg-white border border-gray-200 rounded p-4">
        <h2 className="text-sm font-semibold mb-2">Historique des écarts</h2>
          ...
          <tbody>
            {(historique ?? []).map((s) => (
              <tr key={s.id} className="border-t border-gray-100">
                ...
                <td className={Number(s.ecart) !== 0 ? "text-amber-600 font-semibold" : "text-green-600"}>
