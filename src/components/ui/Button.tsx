...
const VARIANTS: Record<Variant, string> = {
  primary:
    "bg-lime text-ink hover:bg-lime-deep disabled:bg-lime/50 shadow-sm hover:shadow",
  secondary:
    "bg-white text-ink border border-ink/15 hover:border-lime-deep hover:text-lime-deep",
